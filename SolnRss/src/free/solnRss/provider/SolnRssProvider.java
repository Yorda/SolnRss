...
public class SolnRssProvider extends ContentProvider {
	...
	public Cursor query(final Uri uri, final String[] projection, final String selection, final String[] selectionArgs, final String sortOrder) {
		final SQLiteDatabase db = RepositoryHelper.getInstance(getContext()).getReadableDatabase();
		Cursor cursor = null;

		switch (uriMatcher.match(uri)) {
			case PUBLICATION:

				cursor = db.query(PublicationRepository.publicationTableJoinToSyndication, projection, selection, selectionArgs, null, null,
						PublicationRepository.orderBy(getContext()), null);
				break;
			...
			case SYNDICATION:
				cursor = db.query(SyndicationTable.SYNDICATION_TABLE, projection, selection, selectionArgs, null, null,
						SyndicationRepository.orderBy(getContext()));
				break;

			case SYNDICATIONS_BY_CATEGORY:
				cursor = db.query(SyndicationsByCategoryRepository.syndicationsByCategoryTable + uri.getLastPathSegment(), projection, selection,
						selectionArgs, null, null, SyndicationRepository.orderBy(getContext()));
				break;

			case RSS:
				cursor = db.query(RssTable.RSS_TABLE, projection, selection, selectionArgs, null, null, " _id desc ");
				break;

			case CATEGORY_NAME:
				cursor = db.query(CategoryTable.CATEGORY_TABLE, projection, selection, selectionArgs, null, null, null);
				break;

			case PUBLICATION_CONTENT:
				final String tableKey = uri.getQueryParameter("tableKey");
				cursor = db.query(PublicationContentTable.PUBLICATION_CONTENT_TABLE + "_" + tableKey, projection, selection, selectionArgs, null,
						null, null);
				break;
	...
	public int update(final Uri uri, final ContentValues values, final String selection, final String[] selectionArgs) {
		int rowsUpdated = 0;
		final SQLiteDatabase db = RepositoryHelper.getInstance(getContext()).getWritableDatabase();
		...
		switch (uriMatcher.match(uri)) {
			...
			case CATEGORY:
				rowsUpdated = db.update(CategoryTable.CATEGORY_TABLE, values, selection, selectionArgs);
				break;

			case SYNDICATION:
				rowsUpdated = db.update(SyndicationTable.SYNDICATION_TABLE, values, selection, selectionArgs);
				break;

			case RSS:
				rowsUpdated = db.update(RssTable.RSS_TABLE, values, selection, selectionArgs);
				break;
	...
	public Uri insert(final Uri uri, final ContentValues values) {
		...
		switch (uriMatcher.match(uri)) {
			...
			case PUBLICATION_CONTENT:
				final String tableKey = values.getAsString("syndicationId");
	...
	public int delete(final Uri uri, final String selection, final String[] selectionArgs) {
		...
		switch (uriMatcher.match(uri)) {
			case PUBLICATION:
				rowsDeleted = db.delete(PublicationTable.PUBLICATION_TABLE, selection, selectionArgs);
				break;

			case CATEGORY:
				rowsDeleted = db.delete(CategoryTable.CATEGORY_TABLE, selection, selectionArgs);
				break;

			case SYNDICATION:
				rowsDeleted = db.delete(SyndicationTable.SYNDICATION_TABLE, selection, selectionArgs);
				break;

			case RSS:
				rowsDeleted = db.delete(RssTable.RSS_TABLE, selection, selectionArgs);
				break;

			case PUBLICATION_CONTENT:
				final String tableKey = uri.getQueryParameter("tableKey");
				rowsDeleted = db.delete(PublicationContentTable.PUBLICATION_CONTENT_TABLE + "_" + tableKey, selection, selectionArgs);
				break;
