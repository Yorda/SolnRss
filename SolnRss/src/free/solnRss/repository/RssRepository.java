...
public class RssRepository {
	...
	public final String rssProjection[] = new String[] { RssTable.COLUMN_ID,
			RssTable.COLUMN_TITLE, RssTable.COLUMN_URL, };

	SparseArray<String> lastRssFound = new SparseArray<String>();

	public Cursor loadLastRssFound(Integer syndicationId) {
		...
		lastRssFound.clear();
		return context.getContentResolver().query(uri, rssProjection,
				selection.toString(), args.toArray(new String[args.size()]),null);
	}
	
	public boolean isAlreadyRetrieved(String title, String url) {
